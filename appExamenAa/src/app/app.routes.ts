...
import { CatalogoComponent } from './components/catalogo/catalogo'; // <-- Importa el nuevo componente
...
export const routes: Routes = [
  ...
  // Ruta principal: ahora muestra el catálogo (requiere autenticación)
...
{ path: 'reservas/editar/:id', component: ReservaFormComponent, canActivate: [authGuard, roleGuard], data: { role: 'ADMIN' } },
  ...
  // Redirección para rutas no encontradas (al catálogo)
  { path: '**', redirectTo: '' }
];